        ...
        _Card(
          ...
          child: Column(
            ...
            children: [
              ...
              _kv('Batas belanja', rp(batasBelanja(anggaran, target))),
              ...
              Align(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () =>
                      _aturAnggaran(context, ref, key, anggaran, target),
                ),
              ),
            ],
          ),
                ...
                ...wallets.map(
                  (w) => ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () => ref.read(walletRepoProvider).hapus(w.id),
                    ),
                  ),
                ),
              const SizedBox(height: 4),
              const Text(
                'ℹ️ Pengaitan dompet ke transaksi & saldo per-dompet hadir di '
            ...
            content: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: dropdownItems(tipeWallet),
